...
\subsection{Clés de relation}

\paragraph{Une super-clé} désigne un ou plusieurs attributs qui, ensemble, identifient
un et un seul tuple.

\paragraph{Une clé} est une super-clé minimale (si un seul des attributs est
enlevé de la super-clé minimale, elle perd sa propriété d'identification unique).
Généralement, une relation a plusieurs clés, qu'on appelle aussi clés candidates.

\paragraph{La clé primaire} est une clé choisie parmi les clés candidates comme étant
